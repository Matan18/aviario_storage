...
createConnection().then(async connection => {
  ...
  const prodList = [
    { name: 'produtoUltimo1', description: 'dçlfaj', quantity: 43 },
    { name: 'produtoUltimo2', description: 'dçlfaj', quantity: 10 },
    { name: 'produtoUltimo3', description: 'dçlfaj', quantity: 8 },
    { name: 'produtoUltimo4', description: 'dçlfaj', quantity: 45 },
    { name: 'produtoUltimo5', description: 'dçlfaj', quantity: 54 },
    { name: 'produtoUltimo6', description: 'dçlfaj', quantity: 97 },
    { name: 'produtoUltimo7', description: 'dçlfaj', quantity: 1007 },
  ]
